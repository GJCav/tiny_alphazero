...
if __name__ == '__main__':
    ...
    player1 = AlphaZeroPlayer(global_game, None, 50, 1.0, chk_abs_path="5x5syz.pth.tar", player=-1)
    # player2 = RandomPlayer(global_game, 1)
    player2 = AlphaZeroPlayer(global_game, None, 50, 1.0, chk_abs_path="./5x5_rst/best.pth.tar", player=1)
